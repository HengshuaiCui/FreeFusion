...
import utils
from data_RGB_LLVIP import get_test_data
...
parser.add_argument('--weights', default='./checkpoints/whu/model_whu.pth', type=str, help='Path to weights')
...
for dataset in datasets:
    ...
    test_dataset = get_test_data(img_dir_test, img_options={})
